(function () {
    ...
    c.bootstrapGrowl = function (f, a) {
        ...
        a.allow_dismiss && (b.addClass("alert-dismissible"), b.append('<button class="close btn-close" data-bs-dismiss="alert" aria-label="Close" type="button"><span aria-hidden="true"></span></button>'));
        b.append(f);
