...
$(function() {
	...
	$(document).ready(function(){
		...
		var myChart = new Chart(ctx, {
			type: 'doughnut',
			data: {
				labels: ["Liquidity pool and market making", "Ecosystem & airdrop and marketing campaign foundation", "Pre seed, private sale, vc & investors", "IEO and public sale", "Foundation", "Team"],
				datasets: [{
					label: '# of Votes',
					data: [60, 40],
					backgroundColor: [
